...
function consultarAPI() {
    ...
    fetch(url)
        .then(respuesta => respuesta.json())
        .then(datos => mostrarCotizacionHTML(datos.DISPLAY[criptomoneda][moneda])) // cuando se consulta dependiendo que clikea primero en el select el envia la consulta y altera todo
        .catch(error => console.log(error))
}
